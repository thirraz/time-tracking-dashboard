...
export const Profile: FC = () => {
  ...
  return (
    <>
      <article className="w-[90%] h-[13rem] md:w-[20rem] md:h-[30rem] lg:h-[22rem] lg:mb-8 mt-10 md:mt-0 rounded-xl text-white cardForegroundColor">
        <div className=" w-full h-[8.5rem] md:h-auto bg-[bg-indigo-600] flex justify-evenly items-center md:items-start md:flex-col md:pl-7 rounded-lg bg-indigo-600">
          ...
          />
          <div className="md:mb-[3.4rem]">
            <p className="text-[#bdc1ff]">Report for</p>
            <h3 className="text-[1.5rem] md:text-[2.4rem]">Jeremy Robson</h3>
          </div>
        </div>
        <nav className="cardForegroundColor flex md:flex-col md:py-5 h-[4.5rem] md:h-[9rem] md:items-start md:pl-7 justify-around items-center rounded-b-xl text-[#bdc1ff]">
          <a
            href="#"
