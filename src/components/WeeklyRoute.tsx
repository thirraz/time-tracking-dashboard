  ...
  const TimeCardComponentObjectArray = [
    {
      ...
      bgColor: "workCardBg",
      currentHours: dataResponse[0]?.timeframes.weekly.current,
      previousHours: dataResponse[0]?.timeframes.weekly.previous,
    },
    {
      imageIcon: `${playIcon}`,
      title: dataResponse[1]?.title,
      bgColor: "playCardBg",
      currentHours: dataResponse[1]?.timeframes.weekly.current,
      previousHours: dataResponse[1]?.timeframes.weekly.previous,
    },
    {
      imageIcon: `${studyIcon}`,
      title: dataResponse[2]?.title,
      bgColor: "studyCardBg",
      currentHours: dataResponse[2]?.timeframes.weekly.current,
      previousHours: dataResponse[2]?.timeframes.weekly.previous,
    },
    {
      imageIcon: `${exerciseIcon}`,
      title: dataResponse[3]?.title,
      bgColor: "exerciseCardBg",
      currentHours: dataResponse[3]?.timeframes.weekly.current,
      previousHours: dataResponse[3]?.timeframes.weekly.previous,
    },
    {
      imageIcon: `${socialIcon}`,
      title: dataResponse[4]?.title,
      bgColor: "socialCardBg",
      currentHours: dataResponse[4]?.timeframes.weekly.current,
      previousHours: dataResponse[4]?.timeframes.weekly.previous,
    },
    {
      imageIcon: `${selfCareIcon}`,
      title: dataResponse[5]?.title,
      bgColor: "selfCareCardBg",
      currentHours: dataResponse[5]?.timeframes.weekly.current,
      previousHours: dataResponse[5]?.timeframes.weekly.previous,
    },
  ];
